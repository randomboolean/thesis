...
That is to say, in the ternary representation of a classical convolutional layer, $W$ captures the information the layer has learnt, whereas $S$ captures how the layer exploits the symmetries of the input domain.
