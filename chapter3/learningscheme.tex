...
\begin{gather}
%A[i,j] = 0 \Leftrightarrow S[:,i,j] = \textbf{0}
A[i,j] = 0 \Rightarrow \forall k, S[k,i,j] = 0
\end{gather}
In other terms, we say that $S$ is \emph{masked by} $A$.
