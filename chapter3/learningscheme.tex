...
\todo{describe experiments and our model}
  ...
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      \hline
      Citeseer & $56.7 \pm 1.1$ & $72.2 \pm 0.6$ & $72.1 \pm 0.6$ & $71.4 \pm 0.7$ & $72.5 \pm 0.8$ & $\mathbf{72.7} \pm 0.5$\\
      \hline
