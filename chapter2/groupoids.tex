...
We obtain an equivariance characterization similar to \thref{prop:equiG} and \thref{cor:equiM}.
...
\todo{fix domain of $\varphi$ and bijectivity}
\todo{Vincent peux-tu m'aider à corriger lemme 82 et definition 83 pour que ca ait du sens ?}
