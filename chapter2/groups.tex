...
\todo{define equivariant map, then isomorph-equivalence}

\begin{definition}\textbf{Equivalence and equivariant map}\\
Let a subgroup $\Gamma \subset \Phi^*(V)$ such that $\Gamma \cong V$ through an isomorphism $g_v \overset{\varphi}\mapsto v$  and if it verifies the property:
\begin{gather*}
