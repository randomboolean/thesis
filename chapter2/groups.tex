...
\begin{proposition}\textbf{Equivariance to $\Gamma$ through right action}\\
...
\begin{proof}
In the following equations, \eqref{eq:rel} is obtained from \lemref{lem:rel23}, \eqref{eq:left} is obtained because left multiplication in a group is bijective, and \eqref{eq:pty} is obtained because of \eqref{eq:P}.
\begin{align}
