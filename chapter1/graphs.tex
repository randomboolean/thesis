...
For example, \cite{velickovic2017graph} proposed the  a model that learns which input feature maps are most useful to describe a couple of neighboring nodes.
