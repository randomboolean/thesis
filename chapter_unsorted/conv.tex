...
\begin{remark}For $u_1=v_m$ we write $uv$ instead of $vu$ because we'll need the left operand to act on the right one as $u(v)$. The resulting path $uv$ has elements of $v$ before those of $u$ though.
\end{remark}
